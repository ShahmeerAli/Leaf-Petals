...
const CartProvider = ({ children })=>{
    ...
    const addToCart = (plant, quantity = 1)=>{
        setCart((prevCart)=>{
            ...
            if (existingItem) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Increased ${plant.name} quantity in cart!`);
                return prevCart.map((item)=>item._id === plant._id ? {
                        ...item,
                        quantity: item.quantity + quantity
                    } : item);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Added ${plant.name} to cart!`);
                return [
                    ...prevCart,
                    {
                        ...plant,
...
function Navbar() {
    ...
    const { getCartCount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
...
_s(Navbar, "PQM1jJYSmILJ83DJeeO0VRwNMdA=", false, function() {
    return [
...
//# sourceMappingURL=src_d1e14a2b._.js.map
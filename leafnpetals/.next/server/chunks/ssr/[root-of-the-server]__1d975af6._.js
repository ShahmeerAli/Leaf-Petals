...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},48783,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(6704);let e=(0,c.createContext)();a.s(["CartProvider",0,({children:a})=>{let[f,g]=(0,c.useState)([]);(0,c.useEffect)(()=>{let a=localStorage.getItem("plantShopCart");if(a)try{g(JSON.parse(a))}catch(a){console.error("Failed to parse cart",a)}},[]),(0,c.useEffect)(()=>{localStorage.setItem("plantShopCart",JSON.stringify(f))},[f]);let h=a=>{g(b=>b.filter(b=>b._id!==a)),d.default.success("Item removed from cart")};return(0,b.jsx)(e.Provider,{value:{cart:f,addToCart:(a,b=1)=>{g(c=>c.find(b=>b._id===a._id)?(d.default.success(`Increased ${a.name} quantity in cart!`),c.map(c=>c._id===a._id?{...c,quantity:c.quantity+b}:c)):(d.default.success(`Added ${a.name} to cart!`),[...c,{...a,quantity:b}]))},removeFromCart:h,updateQuantity:(a,b)=>{b<=0?h(a):g(c=>c.map(c=>c._id===a?{...c,quantity:b}:c))},clearCart:()=>{g([])},getCartTotal:()=>f.reduce((a,b)=>a+b.price*b.quantity,0),getCartCount:()=>f.reduce((a,b)=>a+b.quantity,0)},children:a})},"useCart",0,()=>(0,c.useContext)(e)])},48305,a=>{"use strict";var b=a.i(87924),c=a.i(75003);a.s(["AuthProvider",0,({children:a})=>(0,b.jsx)(c.SessionProvider,{children:a})])},7456,a=>{"use strict";var b=a.i(87924),c=a.i(38246),d=a.i(75003),e=a.i(48783);function f(){let{data:a}=(0,d.useSession)(),{getCartCount:f}=(0,e.useCart)();return(0,b.jsxs)("nav",{className:"bg-white/80 backdrop-blur-md px-6 py-4 shadow-sm border-b border-green-100 flex justify-between items-center sticky top-0 z-50 transition-all",children:[(0,b.jsxs)(c.default,{href:"/",className:"text-2xl font-black text-green-700 tracking-tighter hover:scale-105 transition-transform",children:["Leaf&",(0,b.jsx)("span",{className:"text-slate-800",children:"Petal"})]}),(0,b.jsxs)("div",{className:"flex items-center gap-4",children:[(0,b.jsx)(c.default,{href:"/",className:"text-slate-600 hover:text-green-700 font-medium transition-colors hidden md:block",children:"Shop"}),a?(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(c.default,{href:"/profile",className:"text-slate-600 hover:text-green-700 font-medium transition-colors hidden sm:block",children:"Profile"}),a.user?.role==="admin"&&(0,b.jsx)(c.default,{href:"/dashboard",className:"bg-slate-800 hover:bg-slate-900 text-white font-medium px-4 py-2 rounded-lg transition-colors shadow-sm text-sm",children:"Admin"}),(0,b.jsx)(c.default,{href:"/api/auth/signout",className:"text-red-500 hover:text-red-700 font-medium transition-colors text-sm border border-red-200 hover:bg-red-50 px-3 py-1.5 rounded-lg",children:"Logout"})]}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(c.default,{href:"/login",className:"text-slate-600 hover:text-green-700 font-medium transition-colors border border-transparent hover:border-green-200 px-4 py-2 rounded-lg",children:"Login"}),(0,b.jsx)(c.default,{href:"/register",className:"bg-green-600 hover:bg-green-700 text-white font-medium px-4 py-2 rounded-lg transition-colors shadow-sm shadow-green-200",children:"Sign Up"})]}),(0,b.jsxs)(c.default,{href:"/cart",className:"relative p-2 text-slate-600 hover:text-green-700 transition-colors",children:[(0,b.jsx)("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"})}),f()>0&&(0,b.jsx)("span",{className:"absolute top-0 right-0 bg-green-500 text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center border-2 border-white",children:f()})]})]})]})}a.s(["default",()=>f])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__1d975af6._.js.map